...
#> 1 SRDM02712C   Inkasa celostátních daň… M              Měsíční        6              milióny        CZK
```
...
#>    indicator_id    indicator_name       frequency_code frequency_name unit_mult_code unit_mult_name unit 
#>    <chr>           <chr>                <chr>          <chr>          <chr>          <chr>          <chr>
#>  1 SFU0QS1313L01LE Finanční účty, Akti… Q              Čtvrtletní     6              milióny        CZK  
#>  2 SFU0QS1313L01T  Finanční účty, Akti… Q              Čtvrtletní     6              milióny        CZK  
#>  3 SFU0QS1313A01LE Finanční účty, Akti… Q              Čtvrtletní     6              milióny        CZK  
#>  4 SFU0QS1313A01T  Finanční účty, Akti… Q              Čtvrtletní     6              milióny        CZK  
#>  5 SFU2QS1313L05T  Finanční účty, F2 O… Q              Čtvrtletní     6              milióny        CZK  
#>  6 SFU2QS1313A05LE Finanční účty, F2 O… Q              Čtvrtletní     6              milióny        CZK  
#>  7 SFU2QS1313A05T  Finanční účty, F2 O… Q              Čtvrtletní     6              milióny        CZK  
#>  8 SFU2QS1313A06LE Finanční účty, F2 O… Q              Čtvrtletní     6              milióny        CZK  
#>  9 SFU2QS1313A06T  Finanční účty, F2 O… Q              Čtvrtletní     6              milióny        CZK  
#> 10 SFU2QS1313L07T  Finanční účty, F2 O… Q              Čtvrtletní     6              milióny        CZK  
#> # ℹ 68 more rows
```
...
#>   indicator_id   indicator_name         frequency_code frequency_name unit_mult_code unit_mult_name unit 
#>   <chr>          <chr>                  <chr>          <chr>          <chr>          <chr>          <chr>
#> 1 SFU2QS1313L05T Finanční účty, F2 Obě… Q              Čtvrtletní     6              milióny        CZK
```
...
#>   indicator_id    indicator_name        frequency_code frequency_name unit_mult_code unit_mult_name unit 
#>   <chr>           <chr>                 <chr>          <chr>          <chr>          <chr>          <chr>
#> 1 SFU2QS1313L05T  Finanční účty, F2 Ob… Q              Čtvrtletní     6              milióny        CZK  
#> 2 SFU2QS1313A06LE Finanční účty, F2 Ob… Q              Čtvrtletní     6              milióny        CZK
```
...
#>   indicator_id  indicator_name          frequency_code frequency_name unit_mult_code unit_mult_name unit 
#>   <chr>         <chr>                   <chr>          <chr>          <chr>          <chr>          <chr>
#> 1 MBOPCAHDPPECY Platební bilance:Běžný… Y              Roční          0              jednotky       proc…
#> 2 MBOPCCHDPPECY Platební bilance:Běžný… Y              Roční          0              jednotky       proc…
#> 3 MBOPDICZXVOLY Platební bilance:Přímé… Y              Roční          9              miliardy       CZK  
#> 4 MBOPLPIXXVOLY Platební bilance:Pasiv… Y              Roční          9              miliardy       CZK  
#> 5 MBOPADSXXVOLY Platební bilance:Aktiv… Y              Roční          9              miliardy       CZK  
#> 6 MBOPAPIXXVOLY Platební bilance:Aktiv… Y              Roční          9              miliardy       CZK
```
...
#> 1 SRDM01202C   SRD       Inkasa celostátních da… FREKVEN… Frekven… M              Měsíční        1       
#> 2 SRDM01202C   SRD       Inkasa celostátních da… STO      Položka… 012            Daň z přidané… 2       
#> 3 SRDM01202C   SRD       Inkasa celostátních da… COUNTER… Sektor … 02             Ekonomika cel… 3       
#> 4 SRDM01202C   SRD       Inkasa celostátních da… CUMMUL   Kumulace C              Hodnoty kumul… 4000    
#> 5 SRDM01302C   SRD       Inkasa celostátních da… FREKVEN… Frekven… M              Měsíční        1       
#> 6 SRDM01302C   SRD       Inkasa celostátních da… STO      Položka… 013            Clo            2
```
...
#>    indicator_id    base_code base_name           dim_code dim_name dim_value_code dim_value_name dim_rank
#>    <chr>           <chr>     <chr>               <chr>    <chr>    <chr>          <chr>          <chr>   
#>  1 SFU2QS1313A06LE SFU2      Finanční účty, F2 … FREKVEN… Frekven… Q              "Čtvrtletní"   1       
#>  2 SFU2QS1313A06LE SFU2      Finanční účty, F2 … SEKTOR_… Sektory… S1313          "Místní vládn… 2       
#>  3 SFU2QS1313A06LE SFU2      Finanční účty, F2 … BALANCE  Balance  A              "Aktiva"       3       
#>  4 SFU2QS1313A06LE SFU2      Finanční účty, F2 … FIN_UCT  Finančn… 06             "Oběživo "     4       
#>  5 SFU2QS1313A06LE SFU2      Finanční účty, F2 … ST       Stavy/t… LE             "Stavy"        5       
#>  6 SFU2QS1313L05T  SFU2      Finanční účty, F2 … FREKVEN… Frekven… Q              "Čtvrtletní"   1       
#>  7 SFU2QS1313L05T  SFU2      Finanční účty, F2 … SEKTOR_… Sektory… S1313          "Místní vládn… 2       
#>  8 SFU2QS1313L05T  SFU2      Finanční účty, F2 … BALANCE  Balance  L              "Pasiva"       3       
#>  9 SFU2QS1313L05T  SFU2      Finanční účty, F2 … FIN_UCT  Finančn… 05             "Oběživo a vk… 4       
#> 10 SFU2QS1313L05T  SFU2      Finanční účty, F2 … ST       Stavy/t… T              "Transakce"    5
```
...
#> File already exists at /var/folders/fr/6f85xds52pq7g55fpmk4z7f80000gn/T//RtmpCVG09p/arad_SRUMD08402C.csv. Loading from cache. Use force_redownload = TRUE to redownload.
```
...
#> File already exists at /var/folders/fr/6f85xds52pq7g55fpmk4z7f80000gn/T//RtmpCVG09p/arad_SRUMD08402C_20121231_20241231.csv. Loading from cache. Use force_redownload = TRUE to redownload.
spending
#> # A tibble: 145 × 6
...
#>   indicator_id      indicator_name      frequency_code frequency_name unit_mult_code unit_mult_name unit 
#>   <chr>             <chr>               <chr>          <chr>          <chr>          <chr>          <chr>
#> 1 SHDPZDRQ1B1GIPSA  Zdroje HDP:Čtvrtle… Q              Čtvrtletní     0              jednotky       proc…
#> 2 SHDPZDRQ1B1GMIPSA Zdroje HDP:Čtvrtle… Q              Čtvrtletní     0              jednotky       proc…
#> 3 SHDPZDRQ1B1GISNA  Zdroje HDP:Čtvrtle… Q              Čtvrtletní     0              jednotky       proc…
#> 4 SHDPZDRQ1D31ISNA  Zdroje HDP:Čtvrtle… Q              Čtvrtletní     0              jednotky       proc…
#> 5 SHDPZDRQ1B1GMISNA Zdroje HDP:Čtvrtle… Q              Čtvrtletní     0              jednotky       proc…
#> 6 SHDPZDRQ1B1GMLSA  Zdroje HDP:Čtvrtle… Q              Čtvrtletní     6              milióny        CZK
```
...
#>  $ period      : POSIXct[1:392], format: "2025-08-31" "2025-07-31" "2025-06-30" ...
